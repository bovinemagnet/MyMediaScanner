...
TMDB:: Create a free account at https://www.themoviedb.org/, then go to *Settings > API* and request a Developer API key. Copy the *v4 API Read Access Token*, not the shorter v3 API key — the v3 key will not work.
