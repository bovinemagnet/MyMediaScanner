...
class _DiscogsApi implements DiscogsApi {
  ...
  Future<DiscogsMarketplaceStatsDto> getMarketplaceStats(
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'curr_abbr': currencyAbbreviation,
    };
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DiscogsMarketplaceStatsDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DiscogsMarketplaceStatsDto _value;
    try {
      _value = DiscogsMarketplaceStatsDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
