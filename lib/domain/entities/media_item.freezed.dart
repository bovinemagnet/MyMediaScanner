...
@override
int get hashCode => Object.hashAll([runtimeType,id,barcode,barcodeType,mediaType,title,subtitle,description,coverUrl,year,publisher,format,const DeepCollectionEquality().hash(genres),const DeepCollectionEquality().hash(extraMetadata),const DeepCollectionEquality().hash(sourceApis),userRating,userReview,dateAdded,dateScanned,updatedAt,syncedAt,deleted]);

@override
String toString() {
  return 'MediaItem(id: $id, barcode: $barcode, barcodeType: $barcodeType, mediaType: $mediaType, title: $title, subtitle: $subtitle, description: $description, coverUrl: $coverUrl, year: $year, publisher: $publisher, format: $format, genres: $genres, extraMetadata: $extraMetadata, sourceApis: $sourceApis, userRating: $userRating, userReview: $userReview, dateAdded: $dateAdded, dateScanned: $dateScanned, updatedAt: $updatedAt, syncedAt: $syncedAt, deleted: $deleted)';
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String barcode,  String barcodeType,  MediaType mediaType,  String title,  String? subtitle,  String? description,  String? coverUrl,  int? year,  String? publisher,  String? format,  List<String> genres,  Map<String, dynamic> extraMetadata,  List<String> sourceApis,  double? userRating,  String? userReview,  int dateAdded,  int dateScanned,  int updatedAt,  int? syncedAt,  bool deleted)  $default,) {final _that = this;
switch (_that) {
case _MediaItem():
return $default(_that.id,_that.barcode,_that.barcodeType,_that.mediaType,_that.title,_that.subtitle,_that.description,_that.coverUrl,_that.year,_that.publisher,_that.format,_that.genres,_that.extraMetadata,_that.sourceApis,_that.userRating,_that.userReview,_that.dateAdded,_that.dateScanned,_that.updatedAt,_that.syncedAt,_that.deleted);}
}
