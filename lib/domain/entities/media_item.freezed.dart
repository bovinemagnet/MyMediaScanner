...
as double?,currentValueAsOf: freezed == currentValueAsOf ? _self.currentValueAsOf : currentValueAsOf // ignore: cast_nullable_to_non_nullable
...
@override final  int? currentValueAsOf;
