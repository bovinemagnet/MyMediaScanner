...
mixin _$RipAlbum {
 ...
 String get id; String get libraryPath; String? get artist; String? get albumTitle; String? get barcode; int get trackCount; int get discCount; int get totalSizeBytes; String? get mediaItemId; String? get cueFilePath; String? get gnudbDiscId; String? get coverPath; int get lastScannedAt; int get updatedAt; bool get deleted;
...
@override
int get hashCode => Object.hash(runtimeType,id,libraryPath,artist,albumTitle,barcode,trackCount,discCount,totalSizeBytes,mediaItemId,cueFilePath,gnudbDiscId,coverPath,lastScannedAt,updatedAt,deleted);

@override
String toString() {
  return 'RipAlbum(id: $id, libraryPath: $libraryPath, artist: $artist, albumTitle: $albumTitle, barcode: $barcode, trackCount: $trackCount, discCount: $discCount, totalSizeBytes: $totalSizeBytes, mediaItemId: $mediaItemId, cueFilePath: $cueFilePath, gnudbDiscId: $gnudbDiscId, coverPath: $coverPath, lastScannedAt: $lastScannedAt, updatedAt: $updatedAt, deleted: $deleted)';
}
...
@useResult
$Res call({
 String id, String libraryPath, String? artist, String? albumTitle, String? barcode, int trackCount, int discCount, int totalSizeBytes, String? mediaItemId, String? cueFilePath, String? gnudbDiscId, String? coverPath, int lastScannedAt, int updatedAt, bool deleted
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String libraryPath,  String? artist,  String? albumTitle,  String? barcode,  int trackCount,  int discCount,  int totalSizeBytes,  String? mediaItemId,  String? cueFilePath,  String? gnudbDiscId,  String? coverPath,  int lastScannedAt,  int updatedAt,  bool deleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RipAlbum() when $default != null:
return $default(_that.id,_that.libraryPath,_that.artist,_that.albumTitle,_that.barcode,_that.trackCount,_that.discCount,_that.totalSizeBytes,_that.mediaItemId,_that.cueFilePath,_that.gnudbDiscId,_that.coverPath,_that.lastScannedAt,_that.updatedAt,_that.deleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String libraryPath,  String? artist,  String? albumTitle,  String? barcode,  int trackCount,  int discCount,  int totalSizeBytes,  String? mediaItemId,  String? cueFilePath,  String? gnudbDiscId,  String? coverPath,  int lastScannedAt,  int updatedAt,  bool deleted)  $default,) {final _that = this;
switch (_that) {
case _RipAlbum():
return $default(_that.id,_that.libraryPath,_that.artist,_that.albumTitle,_that.barcode,_that.trackCount,_that.discCount,_that.totalSizeBytes,_that.mediaItemId,_that.cueFilePath,_that.gnudbDiscId,_that.coverPath,_that.lastScannedAt,_that.updatedAt,_that.deleted);}
}
...
class _RipAlbum implements RipAlbum {
  const _RipAlbum({required this.id, required this.libraryPath, this.artist, this.albumTitle, this.barcode, required this.trackCount, this.discCount = 1, required this.totalSizeBytes, this.mediaItemId, this.cueFilePath, this.gnudbDiscId, this.coverPath, required this.lastScannedAt, required this.updatedAt, this.deleted = false});
