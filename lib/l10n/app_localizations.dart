...
abstract class AppLocalizations {
  ...
  /// No description provided for @settingsTrashEntryTitle.
  ///
  /// In en, this message translates to:
  /// **'Trash'**
  String get settingsTrashEntryTitle;

  /// No description provided for @settingsTrashEntrySubtitle.
  ///
  /// In en, this message translates to:
  /// **'Restore or permanently delete items you removed from the collection'**
  String get settingsTrashEntrySubtitle;

  /// No description provided for @settingsDedupeEntryTitle.
  ///
  /// In en, this message translates to:
  /// **'Find duplicates'**
  String get settingsDedupeEntryTitle;

  /// No description provided for @settingsDedupeEntrySubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @settingsBackupEntryTitle.
  ///
  /// In en, this message translates to:
  /// **'Backup & restore'**
  String get settingsBackupEntryTitle;

  /// No description provided for @settingsBackupEntrySubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @settingsAccessibilityHeading.
  ///
  /// In en, this message translates to:
  /// **'Accessibility'**
  String get settingsAccessibilityHeading;

  /// No description provided for @settingsTextSizeHeading.
  ///
  /// In en, this message translates to:
  /// **'Text size'**
  String get settingsTextSizeHeading;
  ...
  /// No description provided for @trashConfirmCancel.
  ///
  /// In en, this message translates to:
  /// **'Cancel'**
  String get trashConfirmCancel;
}
